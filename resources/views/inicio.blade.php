        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('proyectos', 'Proyectos', ['class' => 'text-center fs-7 my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('ssi', 'SSI', ['class' => 'text-center fs-7 my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('tmc', 'TMC', ['class' => 'text-center fs-7 my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('trabajo', 'Trabajo', ['class' => 'text-center fs-7 my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('manufactura', 'Manufactura', ['class' => 'text-center my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-1 p-2" style="">
                            <div class="menu-hover m-auto rounded-4" style="width: 70%">
                                ...
                                <div class="row m-auto" style="">
                                    {!! Form::label('mecanizado', 'Mecanizado', ['class' => 'text-center my-auto', 'style' => 'font-size:0.9em;']) !!}
                                </div>
                                </a>
                            </div>
                        </div>

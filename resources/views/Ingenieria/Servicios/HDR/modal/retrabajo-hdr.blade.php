<!-- Modal -->
<div class="modal fade" id="retrabajoHdr" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                        <div class="form-group">
                            ...
                            {!! Form::text('m_retra_id_pieza', $orden->nombre_orden, [
                                'class' => 'form-control',
                                'readonly'
                            ]) !!}
                        </div>
                    ...
                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                        <div class="form-group">
                            ...
                            {!! Form::text('m_retra_confec',  $orden->getSupervisor(), [
                                'class' => 'form-control',
                                'readonly'
                            ]) !!}
                        </div>

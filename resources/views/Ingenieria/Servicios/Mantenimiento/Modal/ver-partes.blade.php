            ...
            <div class="modal-body" id="modal-body-ver-partes">
                <div class="row">
                    ...
                    <div class="table-responsive tableFixHead">
                        <table class="table table-striped table-sm" id="verPartes" >
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group" >
                                ...
                                <textarea name='observaciones' id="gmnp-observaciones" maxlength="500" class="form-control" rows="54" cols="54" style="resize:none; height: 20vh"  required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="form-group"> 
                                ...
                                <div class= "input-group">
                                    <input class="form-control" name="horas" type="number" min="0" value="00" id="gmnp-horas" required>
                                    <span class="input-group-text">:</span>
                                    <input class="form-control" name="minutos" type="number" min="0" max="59" value="00" id="gmnp-minutos" required>
                                </div>
                            </div>
                        </div>
                    </div>

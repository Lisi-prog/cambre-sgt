<!-- Modal -->
<div class="modal fade" id="crearOrdenMecaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                        <div class="form-group"> 
                            ...
                            <span class="obligatorio">*</span>
                            {!! Form::select('estado_mecanizado', $estados_mecanizado, null, [

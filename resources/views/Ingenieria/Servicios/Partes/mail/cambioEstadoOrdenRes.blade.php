                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                      La orden de {{$tipo}} <b>"{{$orden}}"</b> del proyecto <b>{{$proyecto}}</b> cambio de estado a <b>{{$estado}}</b>.
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" style="margin: auto;">
                                                                    <tr>
                                                                        <td style="border-radius: 2px; background-color: #04AA6D;">
                                                                            <a href="http://192.168.137.26:8080/ordenes/{{$tipo_ord}}" target="_blank" style="padding: 8px 12px; border: 1px solid #04AA6D; border-radius: 12px; font-family: Helvetica, Arial, sans-serif; font-size: 20px; color: #ffffff; text-decoration: none; font-weight: bold; display: inline-block;">
                                                                                Ordenes
                                                                            </a>
                                                                        </td>
                                                                    </tr>

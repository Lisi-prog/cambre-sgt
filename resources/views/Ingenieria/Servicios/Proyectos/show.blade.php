                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example" class="table table-hover mt-2" class="display">
                                    <thead style="">
                                        ...
                                        <th class="text-center" scope="col" style="color:#fff;width:10%;">Fecha inicio</th>
                                        <th class="text-center" scope="col" style="color:#fff;width:10%;">Fecha limite</th>
                                        <th class="text-center" scope="col" style="color:#fff;width:5%;">Fecha fin real</th>
                                    ...
                                    <tbody>
                                        @foreach ($proyecto->getEtapas as $etapa)
                                            <tr>    
                                                ...
                                                <td class= 'text-center' >{{\Carbon\Carbon::parse($etapa->getActualizaciones->sortByDesc('id_actualizacion_etapa')->first()->getActualizacion->fecha_carga)->format('d-m-Y H:i:s')}}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>

    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Editar Síntomas del Activo</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            {!! Form::open(['route' => 'activo.set_sintomas', 'method' => 'PUT', 'class' => 'formulario form-prevent-multiple-submits']) !!}
            <div class="modal-body">
                ...
                <table id="tabla_set_sintomas" class="table table-striped">
                    ...
                    <tbody>                    
                        @foreach($activo->getSintomasSinUsar() as $sintoma_disponible)
                            <tr>
                                <td>

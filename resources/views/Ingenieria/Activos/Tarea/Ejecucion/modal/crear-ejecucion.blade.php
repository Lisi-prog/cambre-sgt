<div class="modal fade" id="nuevaEjecucionModal" tabindex="-1" aria-labelledby="nuevaEjecucionModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Nueva Ejecución</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            {!! Form::open(['route' => 'tarea_ejecucion.store', 'method' => 'POST', 'class' => 'formulario form-prevent-multiple-submits']) !!}

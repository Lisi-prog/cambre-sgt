                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                      Se ha cargado una nueva <u>solicitud de servicio de ingeniería</u> con el <b>código N° {{$codigo}}</b> a nombre de <b>{{$name}}</b>. Puede gestionar las distintas SSI <a href="http://192.168.137.26:8080/s_s_i" target="_blank">aquí</a>.
                                                      
                                                      </p><br/>
                                                      {{-- <div style="width: 100%; display: grid; align-content: center; justify-content: center;">
                                                        <a type="button" class="button" href="{{route('s_s_i.index')}}" target="_blank" style="text-decoration: none; transition-duration: 0.4s; background-color: #04AA6D; color: white; border: 2px solid #04AA6D; font-size: 24px; padding: 14px 40px; border-radius: 12px;">
                                                            Ver SSI
                                                        </a>
                                                      </div> --}}

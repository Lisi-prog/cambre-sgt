...
namespace App\Http\Controllers\Ingenieria\Solicitud\RSM;
...
class RequerimientoServicioMantenimientoController extends Controller
{
    ...
    {        
        ...
        return view('Ingenieria.Solicitud.RSM.index', compact('ListaRI'));
    }
    ...
    {        
        ...
        return view('Ingenieria.Solicitud.RSM.CrearAlt', compact('Prioridades', 'Sectores'));
    }

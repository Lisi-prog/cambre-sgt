...
<div class="row"> 
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
        <div class="form-group"> 
            <label for="estado_mec" class="control-label fs-7" style="white-space: nowrap;">Estado mecanizado:</label> 
            <span class="obligatorio">*</span> 
            <input class="form-control" name="estado_mec" type="text" id="input-estado_mecanizado" readonly> 
        </div>
    </div>

...
`<div class="row"> 
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
        <div class="form-group">
            <label for="supervisor" class="control-label fs-7 reset" style="white-space: nowrap;">Supervisor:</label> 
            <span class="obligatorio">*</span> 
...
<div class="row"> 
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6"> 
        <div class="form-group"> 
            <label for="tipo_orden_trabajo" class="control-label fs-7 reset" style="white-space: nowrap;">Tipo de orden trabajo:</label> 
            <span class="obligatorio">*</span> 
            <select class="form-select form-group reset-input" id="tipo_orden_trabajo" name="tipo_orden_trabajo" required> 
                <option selected="selected" value="">Seleccionar</option> 
            </select> 
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        <div class="form-group"> 
            ...
            <span class="obligatorio">*</span> 
            <select class="form-select form-group reset-input" id="cbx_estado" name="id_estado" required>
                <option selected="selected" value="">Seleccionar</option>
            </select>
        </div>
    </div>

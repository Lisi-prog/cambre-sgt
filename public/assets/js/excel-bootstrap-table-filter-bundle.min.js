(function ($$1) {
    ...
    var FilterMenu = function () {
        ...
        FilterMenu.prototype.searchToggle = function (value) { //Busqueda
        ...
        FilterMenu.prototype.dropdownFilterContent = function () {
            ...
            //     if(this.options.no_check.includes(element.firstElementChild.value)){
            //         element.firstElementChild.removeAttribute('checked')
            //         console.log(element)
            //     }
    ...
    var FilterCollection = function () {
        ...
        FilterCollection.prototype.initialize = function () {
            var no_check = this.options.no_check
            this.filterMenus.forEach(function (filterMenu) {
                filterMenu.initialize();
                //NO CHECK EXPERIMENTAL
                filterMenu.inputs.forEach(input => {
                    if(no_check.includes(input.value)){
                        input.removeAttribute('checked')
                        filterMenu.selectAllCheckbox.removeAttribute('checked');
                    }
    ...
    $$1.fn.excelTableFilter = function (options) {
        ...
        if (typeof options.no_check === 'undefined') options.no_check = '';
